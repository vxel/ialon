...
public abstract class Pager<T> {
    ...
    protected void updateQueues() {
        ...
        // attach new pages in the grid, ordered by distance from centerPage
        newPages.stream()
     ...
     * @return true if the chunk of this page can be removed from the cache
     */
    protected abstract boolean detachPage(T page);
    ...
    private void detachPageAtLocation(Vec3i pageLocation) {
        ...
        boolean removalAllowed = detachPage(page);
